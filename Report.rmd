...
Comparsion of the overall deathrate by age-group in Germany.
```{r}
...
Linerar model: (regression with dummy varaibles) Age groups compared by their deathrate, in Germany.
```{r}
...
plot(fit)
```
The relationship of the deathrate in the age group between 80 and 84 and the overall deathrate is indeed statistically significant. Without the agegroup of 80-84 the deaths per 100.000 inhabitants would be 857. Whith every death in this age group the overall deaths raise by 1.15. The regression equation is OverallDeaths = 857 + 1,15.
