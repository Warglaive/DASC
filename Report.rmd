...
wesee that the suicide rate from countries in the warsaw pact are way higher. 
...
poioning <- coldwardataset%>%
  filter(Cause=="B48" | Cause=="B50")

ggplot(poioningAndFalls, aes(x=Year, y=Deathcount))+
  geom_point(data = pick(~Countryname=="USSR, Former" & Sex==1 & Cause=="B50"), color="Blue", shape=17)+
  geom_point(data = pick(~Countryname=="USSR, Former" & Sex==2 & Cause=="B50"), color="Pink", shape=17)+
  geom_point(data = pick(~Countryname=="USSR, Former" & Sex==1 & Cause=="B48"), color="Blue")+
  geom_point(data = pick(~Countryname=="USSR, Former" & Sex==2 & Cause=="B48"), color="Pink")
```
