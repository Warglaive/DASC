...
warsawpact <- c("Germany, Former Federal Republic", "Albania", "Bulgaria", "Poland", "Romania", "USSR, Former","Czechoslovakia, Former", "Hungary")
...
ggplot(suiciderate, aes(x = Year, y = Deathcount))+
  geom_point()+
  geom_point(data = pick(~Countryname == "USSR, Former"), colour = "red")+
  geom_point(data = pick(~Countryname == "Russian Federation"), colour = "green")
